...
contract.skip("06 SnailToken - Two snails breedMateBFertilised", async accounts => {
    ...
    describe("Breed Snails: Both mates must be present", () => {
        ...
        it("should NOT allow breedMateBFertilised if neither mate is present (owned/approved)", async () => {

            await truffleAssert.reverts(
                snailToken.breedMateBFertilised(
        ...
        it("should NOT allow breedMateBFertilised if only one mate is present (owned/approved)", async () => {
        ...
        it("should NOT allow a snail to be breedMateBFertilised with itself", async () => {
    ...
    describe("Breed Two Snails (with pseudo-random chance that each mate produces 1x newborn smail): ", () => {
        ...
        it("should allow suitable mates to breedMateBFertilised", async () => {
        ...
        it("should get expected mates A fertilised from each breedMateBFertilised (test 3x)", async () => {

            // Breed (for 1st-time)
            let txBreedResult1
            await truffleAssert.passes(
                txBreedResult1 = await snailToken.breedMateBFertilised(
                    A_SNAIL_ID, //mateA                
                    B_SNAIL_ID, //mateB
                    {from: accounts[2]}),
                "Snail owner was unable to breed their snails"
            ...
            truffleAssert.eventEmitted(txBreedResult1, 'SnailsMated', (ev) => {
                ...
                return Number(ev.snailIdMateA) === A_SNAIL_ID &&
                    ...
                    Boolean(ev.mateAFertilised) === false &&
            ...
            let txBreedResult2
            await truffleAssert.passes(
                txBreedResult2 = await snailToken.breedMateBFertilised(
                    A_SNAIL_ID, //mateA                
                    B_SNAIL_ID, //mateB
                    {from: accounts[2]}),
                "Snail owner was unable to breed their snails"
            ...
            let txBreedResult3
            await truffleAssert.passes(
                txBreedResult3 = await snailToken.breedMateBFertilised(
                    A_SNAIL_ID, //mateA                
                    B_SNAIL_ID, //mateB
                    {from: accounts[2]}),
                "Snail owner was unable to breed their snails"
        ...
        it("should get expected 1x conception from each breedMateBFertilised (test 3x)", async () => {
        ...
        it("should when there are new-born snails (from breedMateBFertilised), emit a 'SnailsBorn' event", async () => {

            let txBreedResult
            await truffleAssert.passes(
                txBreedResult = await snailToken.breedMateBFertilised(
                    A_SNAIL_ID, //mateA                
                    B_SNAIL_ID, //mateB
                    {from: accounts[2]}),
                "Snail owner was unable to breed their snails"
        ...
        it("should, after breedMateBFertilised indicates new-born snail(s), have minted the expected new snails", async () => {
    ...
    describe("Snail Breeding: Pausing  & Unpausing the SnailToken Contract", () => {
        ...
        it("should NOT breedMateBFertilised when SnailToken contract is in 'paused' state", async () => {
        ...
        it("should allow breedMateBFertilised after 'paused' SnailToken contract is 'unpaused'", async () => {
